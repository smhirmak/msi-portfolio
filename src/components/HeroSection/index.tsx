        ...
        <div className="flex justify-between items-center w-full max-w-[1100px] flex-col lg:flex-row">
          <div className="flex-1 w-full cursor-default lg:order-1 order-2 flex items-center flex-col md:order-2 md:mb-8 md:flex md:items-start md:flex-col">
            ...
            <p className="text-base md:text-xl text-center md:text-start text-neutral-300 leading-[32px] mb-4">
              I am a Frontend Developer who delivers innovative solutions and writes clean,
              maintainable code, specializing in developing user-centric and high-performance web
              applications using modern technologies such as{' '}
              <span className="font-semibold text-text-primary">
                React, Next.js, Tailwind CSS, and TypeScript
              </span>
              . I have proven success in responsive design, performance optimization, and user
              experience improvement.
            </p>
            <div className="flex text-2xl md:text-base mb-4">
              <a
                className="inline-block mx-3 text-xl text-text-primary transition-colors"
                href={Bio.linkedin}
                target="display">
                <IconBrandLinkedin
                  size={35}

...
export const Timeline = ({ data, title, desc, className }: { data: TimelineEntry[]; title: string; desc: string; className?: string }) => {
    ...
    return (
        ...
        >
            <div className="px-4 md:px-0">
                <h2 className="text-3xl md:text-5xl mb-4 font-bold text-white max-w-4xl">
                    {title}
                </h2>
                <p className="text-neutral-300 text-xl md:text-3xl">
                    {desc}
                </p>
            </div>

  ...
  return (
    <div className='flex flex-col justify-center relative z-1 items-center pt-20' id="contact">
      <div className='relative flex justify-between items-center flex-col w-full max-w-[1350px] pb-20'>
        ...
        <div className='text-base mt-3 mx-4 md:m-0 md:mb-8 md:text-lg text-center max-w-[600px] cursor-default text-text-secondary'>Feel free to reach out to me for any questions or opportunities!</div>
